...
combined.df <- cbind(age_ap1, age_ap3[,4], age_ap5[,4], age_ap6[,4])

htmlTable(combined.df[combined.df$ethnicity=='J',], rgroup=c('Any Virus','RSV','hMPV','Flu','Adeno', 'paraflu'), n.rgroup=rep(3,6) )

combined.df$virus <- factor(combined.df$virus, levels=c('any','rsv','hmpv','flu','adeno','paraflu'))


combined.df2 <- combined.df[order(combined.df$agec, combined.df$virus, combined.df$ethnicity),]

htmlTable(combined.df2[combined.df2$ethnicity=='J',], rgroup=c('<12m','12-23m','2-4y'), n.rgroup=rep(6,3) )
