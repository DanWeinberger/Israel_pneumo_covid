...
non.caap.waffle <-
  attrib_pct_waffle_age_mcmc(ds='res1.noncaap.all', outcomevar='nonCAAP', plot.title='B. non-CAAP',fill.waffle=F)

ipd.pneu.waffle <-
  attrib_pct_waffle_age_mcmc(ds='res1.ipd.pneu.all', outcomevar='bacteremic.pneumonia', plot.title='C. IPD (pneumonia)',fill.waffle=F)

ipd.other.waffle <-
  attrib_pct_waffle_age_mcmc(ds='res1.ipd.other.all', outcomevar='other.IPD', plot.title='D. IPD (other)',fill.waffle=F)
...
ipd.pneu.waffle <-
  attrib_pct_waffle_age_mcmc(ds='res1.ipd.pneu.all', outcomevar='bacteremic.pneumonia', plot.title='B. IPD (pneumonia)',fill.waffle=F)
