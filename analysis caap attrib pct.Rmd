...
```{r}
caap.waffle <-
  attrib_pct_waffle_age_mcmc(ds='res1.caap.all', outcomevar='CAAP', plot.title='A. CAAP', off.legend=T,fill.waffle=T)

non.caap.waffle <-
  attrib_pct_waffle_age_mcmc(ds='res1.noncaap.all', outcomevar='nonCAAP', plot.title='B. non-CAAP',fill.waffle=T)

ipd.pneu.waffle <-
  attrib_pct_waffle_age_mcmc(ds='res1.ipd.pneu.all', outcomevar='bacteremic.pneumonia', plot.title='C. IPD (pneumonia)',fill.waffle=T)

ipd.other.waffle <-
  attrib_pct_waffle_age_mcmc(ds='res1.ipd.other.all', outcomevar='other.IPD', plot.title='D. IPD (other)',fill.waffle=T)
...
```{r}
caap.waffle2 <-
  attrib_pct_waffle_age_mcmc(ds='res1.caap.all', outcomevar='CAAP', plot.title='CAAP', off.legend=F,fill.waffle=F)
caap.waffle2
