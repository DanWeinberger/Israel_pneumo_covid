...
ggsave('obs_exp_pre_CAAP_Fig 5 v1.tiff',path = './Results', width = 9, height = 3, device='tiff', dpi=400)
...
ggsave('composite_ts.tiff',path = './Results', width = 7, height = 6, device='tiff', dpi=400)
...
caap.waffle2
ggsave('waffle1.tiff',path = './Results', width = 7, height = 5, device='tiff', dpi=400)
...
ggsave('waffle_figS8.tiff',path = './Results', width = 6, height = 6, device='tiff', dpi=400)
